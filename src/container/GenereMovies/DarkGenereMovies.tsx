...
const DarkGenereMovies = ({ text, isLight, reverse, isDarker }: Props) => {
                ...
                <div className='grid grid-cols-12 '>
                    <div className={`col-span-9 pt-4 pb-8 ${reverse ? "col-start-4" : "col-start-0"}`}>
                        ...
                        <Swiper
                            ...
                            navigation={{ nextEl: '.swiper-button-next-tt', prevEl: '.swiper-button-prev-tt' }}
                        >
                    ...
                    <div className={`col-span-3 ${reverse ? "col-start-1 row-start-1" : "col-start-10"} flex flex-col gap-4 justify-center items-start px-5`}>
                        ...
                        <div className={`flex ${isDarker || isLight ? "text-white" : "text-black"}   select-none gap-4`}>
                            <div className="swiper-button-prev-tt z-[1000] flex justify-center items-center rounded-full border w-8 h-8">&#10094;</div>
                            <div className="swiper-button-next-tt z-[1000] flex justify-center items-center rounded-full border w-8 h-8">&#10095;</div>
                        </div>
                    </div>
                </div>
...
export default DarkGenereMovies;
